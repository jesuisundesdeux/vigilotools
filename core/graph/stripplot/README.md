...
**Sample**
```
vgtool issue list --scope 34_montpellier --filter-date "2019-01-01 00:00:00" "2019-11-1 00:00:00" --group-by address  --group-function approved:count:count  --sort-by count --reverse --head 30 --export top.csv
vgtool issue list --scope 34_montpellier --filter-date "2019-01-01 00:00:00" "2019-11-1 00:00:00"  --filter-address file:top.csv:address --filter-address '! Avenue' --group-by address,categorie,daynumber  --group-function approved:count:count  --sort-by address,categorie,daynumber --export pivot.csv
vgtool graph stripplot generate --import pivot.csv --output pivot.png
```
